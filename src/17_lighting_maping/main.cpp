...
int main()
{
    ...
    // 创建着色器程序
    // ------------------------------------
    Shader lightingShader("./src/17_lighting_maping/Shader/basic_lighting.vs", "./src/17_lighting_maping/Shader/basic_lighting.fs");
    Shader lightCubeShader("./src/17_lighting_maping/Shader/light_cube.vs", "./src/17_lighting_maping/Shader/light_cube.fs");
    ...
    //配置物体镜面光贴图
    unsigned int specularusemap = loadTexture("././image/container2_specular.png");
