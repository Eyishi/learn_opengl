...
int main()
{
    ...
    // ------------------------------------
    Shader objShader("./src/10_light/Shader/vertexshader.vs", 
    "./src/10_light/Shader/fragmentshader.fs");

    Shader lightShader("./src/10_light/Shader/vertexshader.vs",
    "./src/10_light/Shader/lightshader.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
            ...
            objShader.setVec3("objcolor",glm::vec3(0.9f, 0.42f, 0.18f));
